...
$sql = "SELECT products.name, products.image_url, products.price, cart_items.quantity 
        FROM cart_items 
                            ...
                            <div class="item-details">
                                ...
                                <div class="quantity">
                                    <button class="quantity-btn" data-action="decrease"
                                        <?php  /* data-product-id="<?= $item['product_id'] ?>"*/?>>-</button>
                                ...
                                <div class="actions">
                                    <button type="button" class="remove-btn"
                                        <?php /*    data-product-id="<?= $item['product_id'] ?>" */?>>Remove</button>
                                </div>
                            </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                        ...
                        function recalculateTotal() {
                            fetch('fetch_cart_items.php')
                                ...
                                .then(data => {
                                    const totalAmount = data.reduce((acc, item) => acc + (item.price * item
                                        .quantity), 0);
                        ...
                        quantityButtons.forEach(button => {
                            button.addEventListener('click', function() {
                                ...
                                const inputToUpdate = document.querySelector(
                                    `.quantity-input[data-product-id="${productId}"]`);
                                let newQuantity = parseInt(inputToUpdate.value);
